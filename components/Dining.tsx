...
const diningOutlets = [
  {
    ...
    image: '/images/restaurant-rivera.png',
...
const chefMenu = [
  { name: 'Grilled River Fish', desc: 'Fresh local catch with citrus glaze', price: '৳2,500', img: '/images/water-body.png' },
  { name: 'Premium Steak', desc: 'Aged beef tenderloin, truffle mash', price: '৳4,500', img: '/images/water-body.png' },
  { name: 'Signature Dessert', desc: 'Dark chocolate lava with berries', price: '৳1,200', img: '/images/water-body.png' },
  { name: 'Mocktail Collection', desc: 'Refreshing tropical blends', price: '৳800', img: '/images/water-body.png' },
];
